...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3" style="margin-left: 176px; width: 92%;">
        ...
        <a href="{{ route('admin.rooms.create') }}" class="btn btn-success">+ Agregar Sala</a>
    </div>
    ...
    <form method="GET" action="{{ route('admin.rooms.index') }}" style="width: 92%; margin-left: 176px;" class="mb-3">
        <div class="row">
            <div class="col-md-3">
                <input type="text" name="name" class="form-control" placeholder="Buscar por Nombre de Sala" value="{{ request('name') }}">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-6 d-flex">
                ...
                <a href="{{ route('admin.rooms.index') }}" class="btn btn-secondary">Restablecer</a>
            </div>
        </div>
    </form>
        ...
        <tbody>
            @forelse($rooms as $room)
                <tr>
                    ...
                    <td>
                        @if($room->image_url)
                            <a href="{{ url($room->image_url) }}" target="_blank">
                                <img src="{{ url($room->image_url) }}" alt="Imagen de la Sala" width="60">
                            </a>
                        @else
                            -
                        @endif
                    ...
                    <td>
                        <a href="{{ route('admin.rooms.edit', $room->id) }}" class="btn btn-sm btn-warning">Editar</a>
